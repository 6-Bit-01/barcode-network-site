...
New submitters can replace their own waiting songs from the original browser using **Your songs**, while **Add another song** reuses existing intake. Selection into Next in Line, Now Playing or Wheel Chosen permanently locks replacement; Wheel candidates pause edits during a spin and pending confirmation. Slot counts, artist credits and purchases are preserved. See [replacement rules and deployment evidence](docs/queue-own-song-replacement-2026-09-24.md).
