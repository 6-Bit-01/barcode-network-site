...
export default function AdminPage() {
  const { isLive, toggleLive, streamUrl, setStreamUrl, isScheduled, sponsorsActive, toggleSponsorsActive, manualOverride, lastError, persisted } = useLiveStatus();
