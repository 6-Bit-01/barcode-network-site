...
export async function POST(req: Request) {
  ...
  if (["pullNext", "startShow", "addWheelSpinOwed", "addSimulationFreeTrack", "addSimulationPaidPriority", "addSimulationCheckoutPending", "addSimulationPaymentFailed", "addSimulationHeldPriority", "clearSimulationTracks", "stageFirstFree"].includes(body.action)) return NextResponse.json(await updateRadioTrack("", body.action));
