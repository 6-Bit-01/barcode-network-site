      ...
      <main className="pt-14 min-h-screen">
        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 py-12">
          <div className="border border-border bg-surface p-6 text-center">
            ...
            <Link href="/radio#queue-status" className="mt-4 inline-block border border-accent px-4 py-2 text-xs uppercase tracking-widest text-accent hover:bg-accent hover:text-background">Back to Radio</Link>
          </div>
        </section>
      </main>
    );
