    ...
    <div className="space-y-6">
      ...
      <section className={`border p-5 space-y-4 ${calibrationReady ? "border-[#3ddc97]/50 bg-[#3ddc97]/5" : "border-[#ffaa00]/50 bg-[#ffaa00]/5"}`}>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <Metric label="Average transition" value={duration(report.pacing.averageTransitionSeconds)} />
          <Metric label="Median transition" value={duration(report.pacing.medianTransitionSeconds)} />
      ...
      <section className="border border-border bg-surface p-5 space-y-4">
        ...
        <div className="overflow-x-auto border border-border bg-background/40">
          <table className="min-w-full text-left text-xs">
            <thead className="text-muted"><tr><th className="p-2">Artist / track</th><th className="p-2">Outcome</th><th className="p-2">Lane / source</th><th className="p-2">Music time</th><th className="p-2">Wall slot</th><th className="p-2">Next transition</th><th className="p-2">Issue</th></tr></thead>
