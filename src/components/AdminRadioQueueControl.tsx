  ...
  return (
    <div className={`${playerPadding} space-y-6`}>
      ...
      {!hasPreparedSession ? (
        ...
        {tab === "active" && <>
          <NextInLineBox entry={nextInLine} readOnly={readOnly} onAction={action} onPlayer={setPlayer} onCopy={copy} />
