  ...
  return (
    <section className="space-y-3 border border-accent/30 bg-background/40 p-4 text-xs">
      ...
      <div className="grid gap-3 md:grid-cols-4">
        <div className="border border-border bg-surface p-3"><p className="uppercase tracking-widest text-muted">Projected Show Runtime</p><p className="mt-1 text-lg font-bold text-foreground">{timingSummary.showRuntimeSummary.projectedLabel}</p></div>
