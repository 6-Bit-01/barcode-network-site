...
export function PublicQueueGateway() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
      ...
      {mounted && pendingNavigation && createPortal(<AsciiSessionPortalIntro label={pendingNavigation.label} detail={pendingNavigation.detail} mode={pendingNavigation.mode} seed={pendingNavigation.href} href={pendingNavigation.href} onSkip={() => { window.location.href = pendingNavigation.href; }} />, document.body)}
