...
export function PublicQueueGateway() {
  ...
  function beginNavigation(event: React.MouseEvent<HTMLAnchorElement>, href: string) {
    ...
    setPendingNavigation({ href, ...navigationVariant(session?.sessionId ?? href) });
    window.setTimeout(() => { window.location.href = href; }, 6000);
  }
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
      ...
      {mounted && pendingNavigation && createPortal(<AsciiSessionPortalIntro label={pendingNavigation.label} detail={pendingNavigation.detail} mode={pendingNavigation.mode} seed={pendingNavigation.href} />, document.body)}
...
function AsciiSessionPortalIntro({ label, detail, mode, seed }: { label: string; detail: string; mode: string; seed: string }) {
  const glyphs = ["#", "/", "\\", "|", "-", "_", "+", "=", "*", ".", ":", ";", "<", ">", "[", "]", "{", "}", "0", "1", "█", "▓", "▒", "░"];
  ...
  return (
    <div className="ascii-session-overlay fixed inset-0 z-[9900] overflow-hidden bg-black p-4 text-center font-mono text-emerald-200" role="status" aria-live="polite">
      ...
      <div className="ascii-portal absolute left-1/2 top-1/2 h-[min(72vw,72vh)] w-[min(72vw,72vh)] -translate-x-1/2 -translate-y-1/2" aria-hidden="true">
      ...
      <style jsx>{`.ascii-session-overlay{animation:ascii-overlay-exit 6s linear forwards}.ascii-crt{background:linear-gradient(transparent 50%,rgba(255,255,255,.055) 50%),radial-gradient(circle at center,rgba(16,185,129,.18),transparent 48%);background-size:100% 6px,100% 100%;animation:ascii-crt-sweep 950ms linear infinite}.ascii-vignette{background:radial-gradient(circle at center,transparent 0 36%,rgba(0,0,0,.56) 70%,rgba(0,0,0,.92) 100%)}.ascii-noise span{position:absolute;opacity:0;color:rgba(110,231,183,.74);text-shadow:0 0 10px rgba(110,231,183,.54);animation:ascii-noise 1.05s steps(2,end) infinite}.ascii-streams span{position:absolute;left:-22%;right:-22%;display:block;white-space:nowrap;color:rgba(110,231,183,.24);letter-spacing:.42em;text-shadow:0 0 12px rgba(110,231,183,.26);animation:ascii-stream-pull 6s cubic-bezier(.18,.82,.22,1) forwards}.ascii-streams span:nth-child(3n){color:rgba(255,170,0,.28);animation-duration:5.6s}.ascii-streams span:nth-child(even){animation-direction:reverse}.ascii-calibration span{position:absolute;background:rgba(110,231,183,.26);box-shadow:0 0 18px rgba(110,231,183,.26);animation:ascii-calibrate 6s ease-in-out forwards}.ascii-calibration span:nth-child(1),.ascii-calibration span:nth-child(2){left:50%;top:8%;bottom:8%;width:1px}.ascii-calibration span:nth-child(2){transform:translateX(-50%) rotate(90deg)}.ascii-calibration span:nth-child(3){left:12%;right:12%;top:50%;height:1px}.ascii-calibration span:nth-child(4){top:12%;bottom:12%;left:50%;width:1px}.ascii-portal{perspective:1000px;filter:drop-shadow(0 0 42px rgba(16,185,129,.38))}.ascii-tunnel-row{position:absolute;left:50%;top:50%;width:105%;color:rgba(110,231,183,.36);letter-spacing:.28em;white-space:nowrap;text-shadow:0 0 14px rgba(110,231,183,.42);transform-origin:center;animation:ascii-tunnel-row 6s cubic-bezier(.16,.8,.22,1) forwards}.ascii-tunnel-row.row-b{color:rgba(255,170,0,.32);animation-delay:.12s;animation-direction:reverse}.ascii-tunnel-row.row-c{color:rgba(255,255,255,.28);animation-delay:.24s}.ascii-ring{position:absolute;inset:0;display:grid;place-items:center;border:1px solid rgba(110,231,183,.28);border-radius:999px;white-space:pre-wrap;line-height:1.8;color:rgba(110,231,183,.86);text-shadow:0 0 12px rgba(110,231,183,.52);animation:ascii-ring-spin 6s cubic-bezier(.18,.82,.22,1) forwards}.ascii-ring-middle{inset:16%;animation-name:ascii-ring-spin-reverse;color:rgba(255,170,0,.72);border-color:rgba(255,170,0,.32)}.ascii-ring-inner{inset:32%;animation-duration:5.2s}.ascii-core{position:absolute;inset:42%;display:grid;place-items:center;border:1px solid rgba(255,255,255,.3);background:rgba(0,0,0,.72);color:#fff;font-size:.65rem;letter-spacing:.3em;animation:ascii-core-open 6s ease-in-out forwards}.ascii-phase{opacity:0;position:absolute;inset-inline:0;bottom:5.25rem;animation:ascii-phase 1.15s ease-out forwards}.ascii-final{opacity:0;animation:ascii-final 6s ease-out forwards}@keyframes ascii-overlay-exit{0%,94%{opacity:1}100%{opacity:0}}@keyframes ascii-crt-sweep{from{background-position:0 0,0 0}to{background-position:0 48px,0 0}}@keyframes ascii-noise{0%,100%{opacity:.08;transform:scale(.8)}50%{opacity:.65;transform:scale(1.12)}}@keyframes ascii-stream-pull{0%{opacity:.1;transform:translateX(-10%) scaleX(1.18)}36%{opacity:.48}78%{opacity:.72;transform:translateX(18%) scaleX(.52)}100%{opacity:0;transform:translateX(42%) scaleX(.08)}}@keyframes ascii-calibrate{0%{opacity:0;transform:scale(.7)}25%{opacity:.9;transform:scale(1)}78%{opacity:.45}100%{opacity:.12;transform:scale(1.08)}}@keyframes ascii-tunnel-row{0%{opacity:0;transform:translate(-50%,-50%) rotate(0deg) scale(.42)}20%{opacity:.45}58%{transform:translate(-50%,-50%) rotate(240deg) scale(1.05)}82%{opacity:.9;transform:translate(-50%,-50%) rotate(460deg) scale(1.34)}100%{opacity:0;transform:translate(-50%,-50%) rotate(620deg) scale(.16)}}@keyframes ascii-ring-spin{0%{transform:rotate(0deg) scale(.42);opacity:.18;filter:blur(2px)}18%{opacity:.8}58%{transform:rotate(380deg) scale(1.1);filter:blur(0)}82%{transform:rotate(620deg) scale(1.28);opacity:1}100%{transform:rotate(720deg) scale(1.45);opacity:.15}}@keyframes ascii-ring-spin-reverse{0%{transform:rotate(0deg) scale(.32);opacity:.16}58%{transform:rotate(-420deg) scale(1.04);opacity:.95}100%{transform:rotate(-760deg) scale(1.34);opacity:.12}}@keyframes ascii-core-open{0%,55%{transform:scale(.2);opacity:.12}78%{transform:scale(1.35);opacity:1;box-shadow:0 0 60px rgba(110,231,183,.45)}100%{transform:scale(2.1);opacity:.1}}@keyframes ascii-phase{0%{opacity:0;transform:translateY(8px);filter:blur(3px)}18%,72%{opacity:1;transform:translateY(0);filter:blur(0)}100%{opacity:0;transform:translateY(-8px);filter:blur(2px)}}@keyframes ascii-final{0%,74%{opacity:0;transform:scale(.96);filter:blur(3px)}82%,94%{opacity:1;transform:scale(1);filter:blur(0)}100%{opacity:0;transform:scale(1.02)}}@media (prefers-reduced-motion: reduce){.ascii-session-overlay{animation:ascii-overlay-exit 2s linear forwards}.ascii-crt,.ascii-noise span,.ascii-streams span,.ascii-calibration span,.ascii-tunnel-row,.ascii-ring,.ascii-core,.ascii-phase,.ascii-final{animation:none}.ascii-final{opacity:1}.ascii-phase-stack .ascii-phase:not(:last-of-type){display:none}}`}</style>
    </div>
  );
}
