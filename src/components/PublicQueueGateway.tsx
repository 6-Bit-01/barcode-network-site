...
export function PublicQueueGateway() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
      <section data-phase={phase} data-pressure={pressure} data-transition={transitionPulse ?? undefined} className={`queue-machine gateway-sticky-stage relative overflow-hidden border bg-surface p-5 ${copy.border} ${copy.glow}`}>
