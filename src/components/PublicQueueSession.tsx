...
function SubmitterOutlookPanel({ snapshot, canSubmit, isFull, onSubmit }: { snapshot: QueuePublicSnapshot | null; canSubmit: boolean; isFull: boolean; onSubmit: () => void }) {
  ...
  const songsAheadCopy = songsAhead > 0 ? `${songsAhead} ${songsAhead === 1 ? "song is" : "songs are"} currently ahead of a new submission.` : "No songs are currently ahead of a new submission.";
