...
export function PublicQueueSession({ sessionId }: { sessionId: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-2 sm:pt-3"><SessionPhasePanel snapshot={snapshot} submissionsOpen={isOpen} canSubmit={canSubmit} isBroadcastActive={isBroadcastActive} /></div>
