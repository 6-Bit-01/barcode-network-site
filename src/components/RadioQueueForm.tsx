        ...
        <div className={`relative w-full max-w-6xl overflow-hidden border bg-background/88 p-4 ${priorityTone} backdrop-blur-md sm:p-5`}>
          ...
          <div className="relative z-10 space-y-4">
            <div className="warp-status-cluster relative pb-3">
              ...
              <div className="mt-4 grid grid-cols-7 gap-1">{steps.map((step, index) => <span key={step} className={`h-1.5 ${index <= activeIndex ? isPriorityRequested ? "bg-[#ffaa00] shadow-[0_0_14px_rgba(255,170,0,0.75)]" : isConfirmed ? "bg-border/80" : "bg-accent shadow-[0_0_14px_rgba(255,0,0,0.75)]" : "bg-border"}`} />)}</div>
