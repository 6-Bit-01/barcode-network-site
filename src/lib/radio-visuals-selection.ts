...
export const RADIO_VISUAL_MUSIC_FAMILY_COUNT = 40;
...
/** One deterministic permutation per forty occurrences, without a deck-boundary repeat. */
...
export function radioVisualSeedForMusicFamily(trackOccurrenceToken: string, familyIndex: number): number {
  ...
  // Forty evenly distributed buckets make this unreachable in practice, while
