...
assert.equal(sessionBoundPolling.includes("if (inFlight)") && sessionBoundPolling.includes("window.setTimeout(() => { void run(); }, delay)"), true, "shared session-bound polling remains single-flight and timeout-driven");
