...
assert.equal(sourceReceiver.includes("data-tiktok-preload-status") && sourceReceiver.includes("data-tiktok-authority") && sourceReceiver.includes("data-tiktok-sync-revision-applied") && sourceReceiver.includes("data-tiktok-startup-grace"), true, "safe TikTok preload, authority, revision, and startup-grace diagnostics exist");
