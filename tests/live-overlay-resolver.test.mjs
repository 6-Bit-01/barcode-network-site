...
assert.equal(receiver.includes("requestSeq") && receiver.includes("latestAppliedSeq") && receiver.includes("AbortController") && receiver.includes("startSessionBoundPolling({ intervalMs: OVERLAY_POLL_DELAY_MS, poll })"), true, "overlay polling is ordered, single-flight, and session-bound");
