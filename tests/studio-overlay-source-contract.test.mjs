...
test("square live and Wheel source follows session lifecycle, resolved ceremony authority, and browser-source audio", () => {
  ...
  assert.match(receiver, /stabilizeLiveOverlayMediaScene\(displayedScene, resolvedScene\)/);
  assert.match(receiver, /combinedVideoActive = wheelOnly[\s\S]*?displayScene\.youtube \|\| displayScene\.tiktok/);
