...
internal static class BridgeLog
{
    ...
    public static string FilePath => Path.Combine(DirectoryPath, "commercial-player.log");
    ...
    public static void Write(string message, Exception? error = null)
    {
        try
        {
            lock (Sync)
            {
                ...
                {
                    File.Move(FilePath, Path.Combine(DirectoryPath, "commercial-player.previous.log"), true);
                }
